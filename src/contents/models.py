...
class User(AbstractUser):
    ...
    password_hash = models.CharField(
        max_length=255)  # Storing password hashes in the same table is a security risk
    ...
    addresses = models.JSONField(
        default=list)  # List of dictionaries containing address details
...
class Product(models.Model):
    # Product Information
    product_id = models.IntegerField(unique=True)  # Not unique, as it's repeated for each order
...
class Order(models.Model):
    ...
    order_id = models.IntegerField(unique=True)  # Not unique, as it's repeated for each product in the order
...
class CustomerSupport(models.Model):
    ...
    support_ticket_status = models.CharField(max_length=50, null=True,
                                             blank=True)
    support_agent_name = models.CharField(max_length=255, null=True,
                                          blank=True)
...
#     product_stock = models.IntegerField()
#     product_ratings = models.JSONField(
#         default=list)  # List of dictionaries containing rating details
#
#     # Order Information
